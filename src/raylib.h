...
RLAPI void InitWindow(int width, int height, const char *title);  // Initialize window and OpenGL context. Passing 0 to width/height opens in fullscreen (provided the flags are appropriately set)
...
RLAPI Texture LoadTextureArrayFromAtlasImage(Image images, int columns, int rows);
...
RLAPI void GenTextureArrayMipmaps(Texture* texture);                                                     // Generate GPU mipmaps for a texture array
RLAPI void GenTextureMipmapsEx(Texture2D* texture, int mipmapsDesired);                                  // Generate GPU mipmaps for a texture
RLAPI void GenTextureArrayMipmapsEx(Texture* texture, int mipmapsDesired);                               // Generate GPU mipmaps for a texture array
RLAPI void SetTextureFilter(Texture2D texture, int filter);                                              // Set texture scaling filter mode
RLAPI void SetTextureArrayFilter(Texture texture, int filter);                                           // Set texture array scaling filter mode
