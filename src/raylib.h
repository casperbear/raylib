...
RLAPI Texture LoadTextureArrayFromAtlasImage(Image images, int rows, int columns);
...
RLAPI void GenTextureArrayMipmaps(Texture* texture);
RLAPI void GenTextureMipmapsEx(Texture2D* texture, int mipmapsDesired);                                  // Generate GPU mipmaps for a texture
RLAPI void GenTextureArrayMipmapsEx(Texture* texture, int mipmapsDesired);
RLAPI void SetTextureFilter(Texture2D texture, int filter);                                              // Set texture scaling filter mode
RLAPI void SetTextureArrayFilter(Texture2D texture, int filter);
RLAPI void SetTextureWrap(Texture2D texture, int wrap);                                                  // Set texture wrapping mode
RLAPI void SetTextureArrayWrap(Texture texture, int wrap);                                             // Set texture array wrapping mode
...
RLAPI void DrawBillboardFromArray(Camera camera, Texture2D texture, Vector3 position, float scale, Color tint, int slice);
RLAPI void DrawBillboardRec(Camera camera, Texture2D texture, Rectangle source, Vector3 position, Vector2 size, Color tint); // Draw a billboard texture defined by source
RLAPI void DrawBillboardRecFromArray(Camera camera, Texture2D texture, Rectangle source, Vector3 position, Vector2 size, Color tint, int slice);
RLAPI void DrawBillboardPro(Camera camera, Texture2D texture, Rectangle source, Vector3 position, Vector3 up, Vector2 size, Vector2 origin, float rotation, Color tint); // Draw a billboard texture defined by source and rotation
RLAPI void DrawBillboardProFromArray(Camera camera, Texture2D texture, Rectangle source, Vector3 position, Vector3 up, Vector2 size, Vector2 origin, float rotation, Color tint, int slice);
